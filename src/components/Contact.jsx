          ...
          >
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  info@mountcarmel.com<br />
                  appointments@mountcarmel.com
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                type="submit"
                className="w-full bg-[#8B0000] text-white px-6 py-3 rounded-md text-lg font-semibold hover:bg-[#6B0000] transition-colors"
              >
                Send Message
              </motion.button>
            </form>
