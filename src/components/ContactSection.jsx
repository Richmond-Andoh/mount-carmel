      ...
      <div className="container position-relative" style={{zIndex: 3}}>
        ...
        <div className="row justify-content-center mb-5">
          <div className="col-lg-8 text-center">
            ...
            <p className="lead text-white-50 mb-0" style={{
        ...
        <div className="row g-5">
          ...
          <div className="col-lg-4 wow fadeIn" data-wow-delay="0.1s">
            <div style={{
              ...
              <p className="text-white-50 mb-5">
                ...
                Don't hesitate to reach out to us for any inquiries or appointments.
              </p>
              
              <div className="space-y-4">
                {contactInfo.map((info, index) => (
                  <div key={index} className="d-flex align-items-start mb-4" style={{
                    animation: isVisible ? `slideInLeft 1s ease-out ${0.8 + index * 0.1}s both` : 'none'
                  }}>
              ...
              <div className="mt-5" style={{
                animation: isVisible ? 'slideInLeft 1s ease-out 1.2s both' : 'none'
              }}>
          ...
          <div className="col-lg-8 wow fadeIn" data-wow-delay="0.5s">
            <div className="position-relative" style={{
              animation: isVisible ? 'slideInRight 1s ease-out 0.6s both' : 'none'
            }}>
              <div className="bg-white p-5 rounded-4" style={{
                ...
                <h3 className="mb-4 text-center fw-bold" style={{color: '#6f3348'}}>Send Us a Message</h3>
                  ...
                  <div className="row g-3">
                    ...
                    <div className="col-12">
                      <div className="form-floating">
                        ...
                        />
                        <label htmlFor="subject" style={{color: '#6f3348'}}>Subject</label>
                      </div>
                    </div>
                    <div className="col-12">
                      <div className="form-floating">
                        <textarea 
                          ...
                          required
                        ></textarea>
                        <label htmlFor="message" style={{color: '#6f3348'}}>Your Message</label>
                      </div>
                    </div>
        ...
        <div className="row mt-5">
          <div className="col-12" style={{
            animation: isVisible ? 'fadeInUp 1s ease-out 1.4s both' : 'none'
          }}>
            <div className="bg-white p-4 rounded-4" style={{
              boxShadow: '0 10px 30px rgba(0, 0, 0, 0.1)',
              backdropFilter: 'blur(20px)',
              border: '1px solid rgba(255, 255, 255, 0.2)'
            }}>
              <h4 className="text-center mb-4 fw-bold" style={{color: '#6f3348'}}>Find Us on the Map</h4>
              <div className="ratio ratio-21x9 rounded-3 overflow-hidden">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3970.0!2d0.0!3d5.0!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNcKwMDAnMDAuMCJOIDDCsDAwJzAwLjAiVw!5e0!3m2!1sen!2sgh!4v1234567890"
                  style={{border: 0}}
                  allowFullScreen=""
                  loading="lazy"
