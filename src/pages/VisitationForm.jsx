  ...
  return (
    <>
      ...
      <div className="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s" style={{
        background: `linear-gradient(rgba(111,34,72,0.7), rgba(168,92,122,0.7)), url('/images/gallery/room-facility.jpg') center/cover no-repeat`,
        position: 'relative',
      ...
      <div className="container-xxl py-5">
        <div className="container">
          ...
          <div className="container-fluid px-0 mt-5" style={{width: '100vw', marginLeft: 'calc(-50vw + 50%)', background: 'linear-gradient(90deg, #e3eafc 0%, #f8f9fa 100%)', borderRadius: '32px', boxShadow: '0 4px 24px rgba(0,51,102,0.08)', padding: '32px 0'}}>
            <div className="container">
              <div className="row g-4">
                <div className="col-12">
                ...
                {[
                  ...
                  <div key={info.title} className="col-12 col-sm-6 col-lg-4 d-flex align-items-stretch wow fadeInUp" data-wow-delay={info.delay}>
                    <div className="benefit-card bg-white rounded-4 shadow-lg p-4 w-100 d-flex flex-column align-items-center justify-content-center text-center h-100" style={{transition: 'transform .3s, box-shadow .3s'}}>
                      <div className="bg-primary rounded-circle d-flex align-items-center justify-content-center mb-3" style={{width: '64px', height: '64px', boxShadow: '0 2px 12px rgba(111,34,72,0.15)'}}>
                        <i className={`fa ${info.icon} text-white fa-2x`} loading="lazy"></i>
                      </div>
                      <h4 className="mb-2 fw-bold text-primary">{info.title}</h4>
                      <p className="mb-0 text-secondary small">{info.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div className="container-fluid px-0 my-auto" style={{ width: '100vw', height: "auto", marginLeft: 'calc(-50vw + 50%)', marginRight: 0, marginBottom: 0, paddingLeft: 0, paddingRight: 0, background: 'linear-gradient(90deg, #6f2248 0%, #a85c7a 100%)', borderRadius: 0, boxShadow: 'none', overflow: 'hidden', boxSizing: 'border-box' }}>
