...
const Services = () => {
  ...
  const services = [
    {
      id: 1,
      category: 'general',
      icon: <FaStethoscope className="text-4xl text-mount-carmel-primary mb-4" />,
      title: 'General Out-patient & In-patient',
      description: 'Comprehensive care including general consultancy, 24-hour emergency services, and antenatal/postnatal consultations.',
      features: ['General Consultancy', '24-Hour Emergency', 'Antenatal & Postnatal Care', 'Immunization'],
    ...
    },
    {
      ...
      features: ['Fertility Assessment', 'Embryo Culture', 'Embryo Transfer', 'High Success Rates'],
    ...
    },
    {
      ...
      features: ['Routine Checkups', 'Maternity Care', 'Surgical Procedures', 'Menopause Management'],
      image: '/images/services/gynecology.jpg'
    },
    {
      id: 4,
      category: 'specialist',
      icon: <FaProcedures className="text-4xl text-mount-carmel-primary mb-4" />,
      title: 'General Surgery',
      description: 'A wide range of surgical procedures performed by our team of experienced surgeons.',
      features: ['Minimally Invasive Surgery', 'Laparoscopy', 'Emergency Surgery', 'Post-operative Care'],
    ...
    },
    {
      id: 6,
      category: 'specialist',
      icon: <FaClinicMedical className="text-4xl text-mount-carmel-primary mb-4" />,
      title: 'Pediatric Services',
      description: 'Comprehensive healthcare for infants, children, and adolescents.',
      features: ['Well-child Visits', 'Vaccinations', 'Sick-child Care', 'Developmental Screenings'],
    ...
    },
    {
      ...
      description: 'Pre-employment and annual health screenings to ensure a healthy and productive workforce.',
      features: ['Pre-employment Checks', 'Annual Physicals', 'Visa Medicals', 'Bi-annual Exams'],
      image: '/images/services/general-medicine.jpg'
    },
    {
      id: 8,
      ...
      description: 'Comprehensive family planning and reproductive health services in collaboration with international specialists.',
      features: ['Counseling & Assistance', 'Modern Equipment', 'Qualified Professionals', 'Confidential Services'],
      image: '/images/services/fertility.jpg'
    },
    {
      id: 9,
      ...
      description: 'Life-threatening condition management and emergency transportation services.',
      features: ['24/7 Urgent Care', 'Rapid Response', 'Ambulance Services', 'Emergency Transportation'],
      image: '/images/services/general-medicine.jpg'
    },
    {
      id: 10,
      ...
      description: 'Advanced diagnostic procedures including blood tests, X-rays, and ultrasounds.',
      features: ['Clinical Biochemistry', 'Microbiology', 'Haematology', 'Radiology & Imaging'],
      image: '/images/services/general-medicine.jpg'
    },
    {
      id: 11,
      ...
      description: 'Specialized intensive care for neonatal patients requiring critical monitoring.',
      features: ['Neonatal ICU', 'Continuous Monitoring', 'Advanced Life Support', 'Specialized Nursing'],
      image: '/images/services/general-medicine.jpg'
    },
    {
      id: 12,
      ...
      description: 'In-house pharmacy for medication dispensing and administration of drugs.',
      features: ['Medication Dispensing', 'Drug Administration', 'Pharmaceutical Counseling', 'Prescription Fulfillment'],
      image: '/images/services/general-medicine.jpg'
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-mount-carmel-light">
              ...
              <div className="d-flex flex-row flex-nowrap overflow-auto gap-3 py-3 px-2" style={{scrollbarWidth: 'none'}}>
                {serviceCategories.map((category) => (
                  <button
                    ...
                    className={`${ activeCategory === category.key ? 'bg-mount-carmel-primary text-white' : 'bg-white text-mount-carmel-primary border border-mount-carmel-primary' } rounded-pill px-4 py-2 fw-semibold shadow-sm transition-all hover:opacity-90`}
              ...
              <div key={service.id} className="col-12 col-sm-6 col-lg-4">
                <div className="card h-100 shadow-lg border-0 rounded-4 overflow-hidden">
                  ...
                  <div className="card-body d-flex flex-column">
                    <h5 className="card-title fw-bold mb-2 text-mount-carmel-primary">{service.title}</h5>
                    <p className="card-text text-muted mb-3 flex-grow-1">{service.description}</p>
                    <ul className="list-unstyled mb-3">
                      {service.features.slice(0, 3).map((feature, i) => (
                        <li key={i} className="d-flex align-items-center mb-2">
                          <span className="me-2" style={{width: '8px', height: '8px', borderRadius: '50%', backgroundColor: '#6f3348'}}></span>
                          <span className="small text-mount-carmel-secondary">{feature}</span>
                        </li>
                      ))}
                    </ul>
                    <a
      ...
      <section className="container-fluid w-100 py-5" style={{background: 'linear-gradient(90deg, #4B1438 0%, #6f3348 100%)', color: '#fff', margin: 0, padding: 0}}>
        <div className="container text-center">
          ...
          <a href="/appointment" className="btn btn-light btn-lg px-5 py-3 rounded-pill shadow" style={{color: '#6f3348', fontWeight: 'bold'}}>Book a Consultation</a>
